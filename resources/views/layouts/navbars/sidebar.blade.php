        ...
        <div class="navbar-inner">
            ...
            <div class="collapse navbar-collapse" id="sidenav-collapse-main">
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item {{ $elementName == 'reqbanner' ? 'active' : '' }}">
                        <a href="{{ route('reqbanner.index') }}" class="nav-link">
                            <i class="ni ni-archive-2 text-default"></i>
                            <span class="nav-link-text">{{ __('Pemohonan Terbit Gambar') }}</span>
                        </a>
                    </li>
                    ...
                    <li class="nav-item active">
                        <a class="nav-link active" href="#navbar-examples" data-toggle="collapse" role="button" aria-expanded="true" aria-controls="navbar-examples">
                            ...
                            <span class="nav-link-text" style="color: #f4645f;">{{ __('Sistem') }}</span>
                        </a>
